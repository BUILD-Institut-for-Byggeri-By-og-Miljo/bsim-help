...
There are five options in the *SimView* menu that are not described under separate points:
...
*   *Clear Selected*: Cancels the selection of objects.

<figure id="center_img">
<img src="./assets/SimViewMenu.gif" alt="Right-click menu in SimView.">
<figcaption>Right-click menu in SimView.</figcaption>
</figure>

The individual menu options call up various dialog boxes that are discussed in greater detail when the individual items are described:
