...
The state function shows some hysteresis between moistening (absorption) and drying (desorption). Empirical formulas are used to describe the moisture capacities on the scanning curves between moistening and drying.
...
In the opposite situation, when the two most recent values of the moisture content show a decrease, i.e. a drying scanning curve is followed,
...
Thus, in the calculations, it is necessary to keep track of the moisture content in the two most recent time steps, so it is possible to determine whether the material is getting drier or wetter.

*u* is the most recently determined moisture content, and u<sub>a</sub> and u<sub>d</sub> are the moisture contents according to the most recently known relative humidity and the absorption and desorption curves, respectively.
