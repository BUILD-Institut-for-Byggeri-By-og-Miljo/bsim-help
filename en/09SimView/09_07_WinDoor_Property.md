...
*   *Side and Overhang*: The local geometry surrounding the object can be described by clicking the *Left, Right and Top buttons, which open [dialog boxes](../24Miscellaneous/24_54_WinDoor_overhangs_and_side-fins.md) for defining the geometry of side fins and overhang*.  
