...
Now the face can be split by selecting the face and the two new *vertices*. Right-click and select the *Split Face* menu option. If the geometric view with thickness of constructions [has been chosen](09_16_SimView_Options.md), a face with a thickness of zero will appear, as a construction has **not** been attached to the new face. A construction can be attached to the new face as described above.
