...
An archive file contains all the help lines and derived faces, windows, doors and zones. *Nodes* can be constructed from the help lines. When the archive file is opened, the above information is loaded, but also the original DXF file, which is recorded together with the original help lines.
...
3.  Drag *nodes* in the old model over to the corresponding nodes in the new model.
