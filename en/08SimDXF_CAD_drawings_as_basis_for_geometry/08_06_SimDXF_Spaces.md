...
Select the *faces* (select or draw a rectangle) that are to define <u>one</u> space and press Ctrl+E. Note that <u>no</u> internal walls must occur within in a space.

<figure id="center_img">
<img src="./assets/dxf07.gif" alt="Highlighting for creating a space.">
...
<figure id="center_img">
<img src="./assets/dxf08.gif" alt="Model with all spaces before WinDoors are added.">
