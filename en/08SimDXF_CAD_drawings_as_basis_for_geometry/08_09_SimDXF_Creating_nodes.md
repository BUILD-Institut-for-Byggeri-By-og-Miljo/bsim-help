...
Construct *nodes* by selecting two non-parallel lines (help lines and/or other lines) + Ctrl+Q, or draw a rectangle over the lines for which nodes are to be calculated, then select *Make All Nodes* (right click + menu selection).
...
<img src="./assets/dxf05.gif" alt="Calculated nodes.">
