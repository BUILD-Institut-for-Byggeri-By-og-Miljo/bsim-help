...
When XSun is active the [XSun-menu](14_02_XSun_menu.md) appears in user interface of BSim and contains, apart from the normal functions of the right-click menu, an option to capture a [video](14_03_XSun_video.md) sequence of a XSun animation.
