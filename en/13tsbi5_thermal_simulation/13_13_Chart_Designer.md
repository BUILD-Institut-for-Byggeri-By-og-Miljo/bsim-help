...
<img src="./assets/CHARTD1.GIF" alt="The Chart Designer option.">
<figcaption>The Chart Designer option.</figcaption>
</figure>
...
<figure id="center_img">
<img src="./assets/CHARTD2.GIF" alt="The Title option.">
<figcaption>The Title option.</figcaption>
</figure>
...
<figure id="center_img">
<img src="./assets/CAXIS1.GIF" alt="Modifying the appearance of the axes (in this case the X-axis), the appearance of max./min., the marks and the intersection with the second axis.">
<figcaption>Modifying the appearance of the axes (in this case the X-axis), the appearance of max./min., the marks and the intersection with the second axis.</figcaption>
</figure>
...
<figure id="center_img">
<img src="./assets/CAXIS2.GIF" alt="Changing axis type.">
<figcaption>Changing axis type.</figcaption>
</figure>
...
<figure id="center_img">
<img src="./assets/CAXIS3.GIF" alt="Changing the line type for the axis (in this case the X-axis).">
<figcaption>Changing the line type for the axis (in this case the X-axis).</figcaption>
</figure>
...
<figure id="center_img">
<img src="./assets/CSERIES1.GIF" alt="The second tab in Series allows the order of the displayed data to be changed.">
<figcaption>The second tab in Series allows the order of the displayed data to be changed.</figcaption>
</figure>
...
<figure id="center_img">
<img src="./assets/CSERIES2.GIF" alt="The Options tab for a data series.">
<figcaption>The Options tab for a data series.</figcaption>
</figure>
...
<figure id="center_img">
<img src="./assets/CSERIES3.GIF" alt="Dialog box for changing the appearance of a series.">
<figcaption>Dialog box for changing the appearance of a series.</figcaption>
</figure>
...
<figure id="center_img">
<img src="./assets/CSERIES4.GIF" alt="Dialog box for changing the graphical representation of statistical information on a series.">
<figcaption>Dialog box for changing the graphical representation of statistical information on a series.</figcaption>
</figure>
