...
An [automatic function](13_03_Converting_weather_data_for_tsbi5.md) for converting energy+/ASHRAE climate data files to the binary BSim format has been implemented in BSim from version 2002, using the *tsbi5* | *File* | *Weather Data* | *ASHRAE* command.
...
*   *Description*: Information about the contents of the climate file (the field <u>must</u> be filled in).
...
*   [*Fixed columns from left to right*](13_03_Converting_weather_data_for_tsbi5.md): Defines the location of data in columns (index starting with 1 at left). Used in connection with format *Fixed*.
...
In the rows of the sheet the individual parameters in the data file is defined one by one in the [*Weather Data Definition Row dialog*](13_03_Converting_weather_data_for_tsbi5.md), say which parameter, scaling and unit, as well as the relative position (parameter number or column number) in the line counted from left to right.
...
| Hour                       | [-] 1 to 24                                                                |
| Temperatures               | °C or °F                                                                 |
| Cloud cover                   | fraction (0-1) or octas (0-8)                                               |
| Solar incidence                 | J/cm² or W/m²                                                            |
| Enthalpy                    | kJ/kg                                                                       |
| Absolute humidity        | kg H₂O/kg dry air                                                          |
| Relative humidity       | % or fraction (0-1)                                                         |
