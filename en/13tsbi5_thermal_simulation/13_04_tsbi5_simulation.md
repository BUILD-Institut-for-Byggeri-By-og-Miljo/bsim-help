...
*   When the simulation has ended, the *Save Log As* button can be used to save the current results file in a new name for later [comparison](13_08_tsbi5_Parameters.md) with other results files of the same model exposed to parametric changes.
