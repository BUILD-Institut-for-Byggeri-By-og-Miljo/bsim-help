...
*The dialog is opened by right clicking the Site icon  <img src="./assets/Site.gif" width=25> in the tree. If Site does not exist it can be created by right clicking the building in the tree and selecting "Add Site".*
...
*   *Browse:* Opens a dialog for selecting a climate file. Next to the *Browse-button,* information about the selected climate file is shown. If no *climate* file is selected or BSim cannot locate it, the dialog opens in the sub-folder *Climate* of the folder where BSim is installed.
...
*   *Site Properties* list the default values for the site used in the simulations.
    ...
    *   *Emissivity:* Emissivity of the ground/surroundings.
*   *Terrain Type* indicates how exposed the building is to wind. The information is used when [simulating natural ventilation](../24Miscellaneous/24_71_Natural_Ventilation.md). The following terrain types are implemented:
