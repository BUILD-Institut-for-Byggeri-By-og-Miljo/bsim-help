...
*   *Pane*
    ...
    *   *Absorptance* is the absorptance for face 1 and face 2 of the glazing. Input is treated as described under reflectance.
*   *Source of Data* is a text field for documentation of the source of the given data.

In the calculation of the glazing temperature it is assumed that all layers of the glazing are the same, and reflectance and absorptance are the same for all glass layers (half of the given values).
