...
The *Lower Limit* parameter is closely linked to *Temp. Max,* which comes after it, and specifies a lower limit for total incident solar radiation, above which the general lighting is switched off if the temperature exceeds the *Temp. Max* value. The value of this parameter should normally be set lower than the <a href="#lightctrl-dialog">Solar Limit</a> parameter, which is defined in the lighting dialog box.
