...
*   *Room Temp*: Opens a [dialog](24_56_Room_Temperature.md) for definition the temperature and moisture variation in a space (outside thermal zones) as a cosine shaped function.
