...
The external surface resistance is used in all cases. The convective surface resistance is used for the internal surface resistance when calculations are done with [long-wave radiation exchange](../13tsbi5_thermal_simulation/13_02_tsbi5_options.md) in tsbi5. The total surface resistance for a face in this type of simulation is dependent on the surface temperature of the faces with which the current face exchanges radiant heat. In this case heat transfer from radiation is calculated dynamically.
