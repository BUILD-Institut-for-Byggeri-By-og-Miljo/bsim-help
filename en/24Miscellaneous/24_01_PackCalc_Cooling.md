...
<img src="./assets/PackCa2.jpg" alt="">
<figcaption></figcaption>
</figure>

Pack Calculation is an application for comparing the yearly energy consumption of refrigeration plants. Among other features, transcritical CO<sub>2</sub> systems can be compared with traditional systems.

The application makes this comparison based on a geographical location.
