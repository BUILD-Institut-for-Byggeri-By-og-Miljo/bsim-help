...
The model are being calculated several times (up until the maximum number of allowed [iterations/days](24_16_tsbi5_general_options.md)) using the outdoor climate of the first day of the simulation period. All air node temperatures of the thermal zones are being recorded for hour 14.
