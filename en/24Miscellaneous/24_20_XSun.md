...
*   *Next Time:* Changes the position of the sun one time step ahead (*defined in Hour Step*) when an eventual animation has been stopped - short cut: *Alt-n*

*   *Previous Time*: Changes the position of the sun to one time step earlier (defined in *Hour Step*) when an eventual animation has been stopped - short cut: *Alt-p*
