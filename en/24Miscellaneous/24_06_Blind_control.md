...
*   Θ<sub>p</sub> is the [profile angle](../24Miscellaneous/24_31_Profile_angle.md),
...
*   Θ is the [profile angle](../24Miscellaneous/24_31_Profile_angle.md) calculated from the solar-window azimuth and the solar height,
