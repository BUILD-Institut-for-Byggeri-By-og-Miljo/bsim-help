...
The dialog offers the possibility of giving a number to create a new unique [SfB number](24_39_SfB_in_BSim.md). It is important to give a number which creates a new unique SfB number in the database.
