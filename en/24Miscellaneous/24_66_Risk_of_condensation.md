...
| 0–1 | The surface temperature is 0–5 °C above the dew point temperature of the surrounding air and *CondRisc* is calculated as:  <br> $$ \text{CondRisc} = 1 - \frac{\Delta T}{5} \tag{1} $$ |
