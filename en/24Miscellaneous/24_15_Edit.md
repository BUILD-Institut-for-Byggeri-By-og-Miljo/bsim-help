...
*   *Options*...: Opens the [dialog box](../09SimView/09_16_SimView_Options.md) for changing the software settings. If tsbi5 is active a [dialog for viewing and changing standard parameters for tsbi5](../24Miscellaneous/24_16_tsbi5_general_options.md) is opened.
...
*   Add: Opens a sub menu for:
    ...
    *   a [space](../09SimView\09_15_SimView_Creating_a_space.md) to the selected face,
...
*   *Clean Model*: Allows to choose between two functions to tidy the model:
    ...
    *   *Model* removes surplus information and objects from the model, *Geometry* cleans the geometry i.e. by combining vertexes with a distance less than the "snap" distance (see [Options](../09SimView/09_16_SimView_Options.md)).