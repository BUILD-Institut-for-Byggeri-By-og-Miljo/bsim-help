...
<img src="./assets/room_property_ok.jpg" alt="The thermal properties of a space (Room Property) can be given as a real thermal zone or a fixed temperature profile by clicking Room Temp.">
...
If the space always has the same indoor conditions as a real thermal zone, this zone can be selected from *Thermal Properties*.

The indoor climate variation in a space can also be described as a cosine shaped variation over the year and day.
...
<span style="letter-spacing: -0.01em;">As a daily variation on the calculated daily space temperature, a daily variation can be forced on top of each daily average temperature. The variation is step-wies for each hour:</span>
...
<figure id="center_img">
<img src="./assets/dswing.jpg" alt="Daily variation of the temperature in a space with an average day- temperature of 21 °C, a maximum temperature in hour 13 and a daily temperature variation of 4 °C.">
