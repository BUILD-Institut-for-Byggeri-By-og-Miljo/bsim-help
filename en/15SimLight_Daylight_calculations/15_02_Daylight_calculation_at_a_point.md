...
It is possible to choose among the already defined reference points in the current room. Multipls reference points can be created by right-clicking the actual room in the tree structure, and selecting the entry [*Ref. points*](../10Thermal_zones/10_03_Reference_point.md).
...
The program do also calculate the solar light factors ([SF1, SF2 og SF3](../10Thermal_zones/10_07_Solar_light_factors_for_WinDoors.md)) for all WinDoors in the space and they can be transferred automatic to the WinDoors of the space by clicking the *Transfer SF* button. The *Transfer SF* action saves the coordinates of the reference point for the actual space. This means that solar light factors for each space can be calculated - the reference point saved - and transferred one at the time for the whole model. The transferred solar light factors are shown in the [*Windoor Property*](../24Miscellaneous/24_75_Model_information.md) dialog when right-clicking the WinDoor's of the space in the tree-structure.  
