...
Different data are being used when simulating the thermal indoor climate, the energy flows and the daylight conditions. Data for the color of the surface are, however, only used in daylight simulations and in export of building models to [*Radiance*](../18Radiance_Visualisation_og_the_building/18_01_Exporting_data_to_Radiance.md) for further analyses.
...
*   SolarAbs.: Absorpstance of solar radiation is being used in the thermal simulation of solar heating distribution to the surfaces of the model.

*   LightRefl.: The light reflectance is used in the simulation of daylight in *SimLight*.
