...
It is not possible to display the calculated curve correctly on the [*Glazing*](../07SimDB_Database/07_10_SimDB_BuildingMaterial_Glazing.md) tab before the last field to be edited is exited using the arrow keys.

<figure id="center_img">
<img src="./assets/dbtransm.gif" alt="Table for entering detailed information on the dependence of transmittance on the angle of incidence.">
