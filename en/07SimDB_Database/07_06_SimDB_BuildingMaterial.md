...
*   **a** is used for the glazing in the WinDoor's (*glazing*)

*   **b** is used for the frame around the glazing in the WinDoor's (*frame*)

*   **c** is used for the panel connected to the WinDoor's (*panel*)
...
*   **9** is used for defining photovoltaic systems
...
*   [Tab Transmittance](../07SimDB_Database/07_16_SimDB_BuildingMaterial_UserDefined.md)
