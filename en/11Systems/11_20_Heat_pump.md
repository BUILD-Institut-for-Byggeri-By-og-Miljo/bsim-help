...
# Heat pump, System
The scheme provides data for a potential heat pump contributing to space heating. Data are determined according to relevant European standards.
...
*   *Type:* In this field it is selected whether the heat pump is solely for production of domestic hot water (dhw) or can produce both hot water and heating. Alternatively, it can be a duo solution with one heat pump for domestic hot water and one for space heating. **NB: Systems for production of domestic hot water are currently inactive in BSim.**

Room Heating

*   *Nom. Efficiency:* The nominal power is the power delivered from the heat pump at the test conditions as stated below. For heat pumps for dhw the nominal power is not necessarily determined in the test. In these cases the average annual power for heating dhw can be used instead.
...
*   *Rel. COP 50 % load*: The relative COP at 50 % load of the heat pump is the COP at 50 % load divided by the COP at 100 % load. The relative COP at 50 % load of the heat pump is determined according to CEN TS 14825. If the relative load is not determined according to CEN TS 14825, a value of 0.80 is assumed. The parameter is not relevant for heat pumps for dhw.
...
*   Source: This section defines the media on the cold side of the heat pump, i.e. which source and which media the heat is delivered to at the hot side. The media is selected in the combo box.
...
The heat pump cannot be activated as a source for the heating system until the external program [PackCalc](../24Miscellaneous/24_01_PackCalc_Cooling.md) has been installed. PackCalc has been developed by IPU Technology development at Danish Technical University (DTU).
