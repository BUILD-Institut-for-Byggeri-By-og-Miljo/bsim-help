...
<img src="./assets/ventilation-inletctrl.gif" alt="Defining the control strategy for inlet control. The curve shows the control of the inlet air temperature according to the given input. The curve is refreshed when focus changes from one input field to another.">
<figcaption>Defining the control strategy for inlet control. The curve shows the control of the inlet air temperature according to the given input. The curve is refreshed when focus changes from one input field to another.</figcaption>
</figure>
...
*Slope before 1* and *Slope after 2*: Specifies the slope of the lines that make up the control curve at outdoor temperatures below *Te1* and above *Te2,* as shown in the graph. The example in the graph has a slope of 0 before *P1* and 0.4 after *P2.*
