...
<img src="./assets/Equipment.gif" alt="Dialog box for defining the load from equipment. If New is clicked, it is possible to give the equipment a name and a load in kWh (Heat Load), as well as to specify how large a proportion of the heat given off is transferred directly (by convection) to the air in the thermal zone (Part to Air).">
<figcaption>Dialog box for defining the load from equipment. If New is clicked, it is possible to give the equipment a name and a load in kWh (Heat Load), as well as to specify how large a proportion of the heat given off is transferred directly (by convection) to the air in the thermal zone (Part to Air).</figcaption>
</figure>
...
[*Schedule*](11_02_Systems_schedule.md) defines connected sets of control and time definitions. The control for "equipment" is of the [day profile](11_04_Systems_DayProfile.md) type, with the variation over the hours of the day being specified as a percentage.
