# Colophone
**Danish Building Research Institute** [publications](https://www.build.aau.dk/til-byggebranchen) are issued in the following series: Directions, Results, Documentations and Concrete. The publications can be obtained through bookshops or by taking out a subscription. The Institute's annual report, catalogue of publications is available free of charge from Danish Building Research Institute.
...
*Danish Building Research Institute, SBi: BSim - User's Guide*. Followed by the version number for the guide (see at the top of all help pages).