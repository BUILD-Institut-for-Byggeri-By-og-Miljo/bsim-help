...
Some of the parameters in the formulas written above are variable functions of the temperature or the humidity level, and the relevant time period also has to be chosen. For moisture penetration into walls and furnishing in contact with the indoor air the following choices will be made:
...
| Material              | Dry density, $ \rho_0 $ | Vapour permeability @ 50% RH | Moisture content, u @ 40% RH | Moisture content, u @ 60% RH | Effective Moisture Penetration Depth, $ s_{36.7\%} $ |
|----------------------|------------------------|------------------------------|------------------------------|------------------------------|------------------------------------------------------|
|                      | kg/m³                  | kg/(m·s·Pa)                  | kg/kg                        | kg/kg                        | m                                                    |
