...
<img src="./assets/Fugtfigur1.gif" alt="">
...
$$
\begin{aligned}
x_{\text{air}}^{\text{new}} &\Biggl(
  1 
  + \frac{\Delta t}{V \rho_{\text{air}}} 
      \sum_{\text{constr}} \frac{P}{x_{\text{air}}^{\text{old}} + 0.62198} \frac{A_{\text{surf}}}{Z_{\text{surf}}} 
  + \Delta t \Bigl( n_{\text{out}} + \sum_{\text{zones}} n_{\text{zone}} \Bigr)
\Biggr) \\[1mm]
&= x_{\text{air}}^{\text{old}} 
   + \frac{\Delta t}{V \rho_{\text{air}}} \sum_{\text{constr}} \frac{A_{\text{surf}} p_{\text{surf}}}{Z_{\text{surf}}} \\ 
&\quad + \Delta t \Bigl( n_{\text{out}} x_{\text{out}} + \sum_{\text{zones}} n_{\text{zone}} x_{\text{zone}} \Bigr) 
   + \frac{\Delta t}{V \rho_{\text{air}}} G_{\text{air,syst}}
\end{aligned}
\qquad (5)
$$
...
<figure id="center_img">
<img src="./assets/Fugtfigur2.gif" alt="">
<figcaption></figcaption>
</figure>
