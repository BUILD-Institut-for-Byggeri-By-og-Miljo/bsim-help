...
 $$ Gr = \frac{g \cdot \beta \cdot \Delta T \cdot L^3}{v^2} \tag{1} $$

For air at normal room temperature (20°C), this can be simplified as:

$$ Gr = \frac{9.81 \cdot 0.00341 \cdot \Delta T \cdot L^3}{(1.511\cdot 10^{-5})^2} = 1.47 \cdot 10^8 \cdot \Delta T \cdot L^3 \tag{2} $$
...
$$ \alpha_c = \frac{\lambda}{L} \cdot Nu \tag{3} $$

For air at normal room temperature, this is:

$$ \alpha_c = \frac{0.0257}{L} \cdot Nu \tag{4} $$
...
$$ \alpha_c = 1.42 \left(\frac{\Delta T}{L} \right)^{0.25} \; W/m^2 K \tag{5} $$

Turbulent conditions, large surfaces (Δ*T* > 9.5/L<sup>3</sup>):

$$ \alpha_c = 1.31 \cdot (\Delta T)^{0.33} \; W/m^2 K \tag{6} $$
...
$$ \beta_{v} = \frac{\alpha_c}{\rho \cdot c} \; m/s \tag{10} $$
