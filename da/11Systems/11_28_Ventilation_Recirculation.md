...
*   *Min Supply Ratio* er den mindst tilladelige andel (af *Supply* givet på fanebladet [Ventilation](../11Systems/11_21_Systems_Ventilation.md)) af luft (udeluft + recirkuleret luft) som anlægget forsyner zonen med.
...
*   *Min Inlet Temp* er den mindste indblæsningstemperatur som accepteres i zonen. Indblæsningstemperaturen vil opnå *Min Inlet Temp* hvis der er aggregater tilgængelige i ventilationssystemet (faneblad [Ventilation](../11Systems/11_21_Systems_Ventilation.md)) som kan hæve lufttemperaturen.

*   *Max Inlet Temp* er den højeste indblæsningstemperatur som accepteres i zonen. Indblæsningstemperaturen vil opnå *Max Inlet Temp* hvis der er aggregater tilgængelige i ventilationssystemet (faneblad [Ventilation](../11Systems/11_21_Systems_Ventilation.md)) som kan sænke lufttemperaturen.

*   *Setp Temp* er den ønskede operative temperatur for zonen.

Reguleringen af ventilationsluften med recirkulation af ventilationsluften sker i henhold til beskrivelsen i [teoriafsnittet](../11Systems/11_28_Ventilation_Recirculation.md).
