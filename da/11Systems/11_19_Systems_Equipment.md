...
[Tidsplanen](../11Systems/11_02_Systems_schedule.md) *(Schedule)* definerer sammenhørende sæt af regulering og tidsangivelse. Reguleringen for 'udstyr' er af typen [døgnprofil](../11Systems/11_04_Systems_DayProfile.md), hvor variationen over døgnets timer angives i procent.

Når systemet er navngivet og effekten bestemt, skal de øvrige nødvendige faneblade udfyldes. Vælg fanen [Schedule](../11Systems/11_02_Systems_schedule.md) og vælg [DayProfile](../11Systems/11_04_Systems_DayProfile.md).

Herefter skal de perioder af året, hvor systemet kan være i drift, defineres på fanen tidsangivelse ([Time](../11Systems/11_17_Systems_Time.md)).

Se også

Fanebladet [Schedule](../11Systems/11_02_Systems_schedule.md)   
Fanebladet [DayProfile](../11Systems/11_04_Systems_DayProfile.md)   
Fanebladet [Time](../11Systems/11_17_Systems_Time.md)
