...
<img src="./assets/VIDEO1.GIF" alt="Dialog for navngivning af video filer med XSun animation.">
...
<figure id="center_img">
<img src="./assets/VIDEO3.GIF" alt="Dialog for valg af kompression af video-fil.">
...
<figure id="center_img">
<img src="./assets/VIDEO4.GIF" alt="Valgmenu for definition af komprimerings-rutine til video-filer.">
...
Herefter kan optagelsen startes fra XSun-menuen ([højre-klik menu](../14XSun_Analysis_of_incident_solar_radiation/14_02_XSun_menu.md) eller [programmenu](../14XSun_Analysis_of_incident_solar_radiation/14_02_XSun_menu.md)). Optagelsen af levende billeder startes fra XSun-menuen via indgangen *Capture Animation*.
