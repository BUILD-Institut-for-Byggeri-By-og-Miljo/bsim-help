...
Når materialernes data er defineret i [*BuildingMaterial* ](../07SimDB_Database/07_06_SimDB_BuildingMaterial.md)delen af databasen, kan der opbygges bygningselementer på baggrund af disse. Som tidligere nævnt, er bygningselementerne klassificeret i henhold til SfB-systemets overordnede grupper, fx 21. for udvendige vægge (*Walls*, *external walls*).
...
Nye bygningselementer dannes - fra "scratch" - ved tryk på knappen *New*. Herved [kaldes en dialog](../07SimDB_Database/07_02_SimDB_BuildingElement.md) frem til valg af overordnet gruppe i [SfB-systemet](../24Miscellaneous/24_39_SfB_in_BSim.md), fx 3x. *Completion* og undergruppen 31. *External walls*. Når der er oprettet et navn (vælg et godt, sigende navn) til det nye bygningselement, kan elementets enkelte lag defineres via dialogerne, som kommer frem ved klik på knappen *Edit*.

Det er også muligt at oprette nye bygningselementer ved at tage udgangspunkt i en [kopi](../24Miscellaneous/24_41_Copy_building_elements.md) af et eksisterende element.

Ved klik på [About](../24Miscellaneous/24_42_About_SimDB.md) knappen vises en dialog med information om den valgte database.
