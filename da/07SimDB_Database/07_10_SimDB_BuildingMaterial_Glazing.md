...
Fanebladene *Glazing* og [*UserDefined* ](../07SimDB_Database/07_16_SimDB_BuildingMaterial_UserDefined.md)hører sammen og indeholder informationer, som knytter sig til transparente materialer, der benyttes som en del af en WinDoor og indgår i simuleringer med *tsbi5*. Disse faneblade vises **kun** for materialer fra [SfB-materialegruppe](../24Miscellaneous/24_39_SfB_in_BSim.md) "a".
...
*   *User Defined Curve*: Inaktivt felt som ved "hak" angiver at transmittanskurven er beregnet på baggrund af detaljerede data, givet på fanebladet [*UserDefined*](../07SimDB_Database/07_16_SimDB_BuildingMaterial_UserDefined.md).
...
*   [Faneblad Additional](../07SimDB_Database/07_10_SimDB_BuildingMaterial_Glazing.md)
