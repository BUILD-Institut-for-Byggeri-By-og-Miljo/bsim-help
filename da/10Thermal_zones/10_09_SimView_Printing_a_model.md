...
# Udskrift af model
Alternativt til *ModelList* er *ModelDoc* som kaldes via *View* | [*ModelDoc*](../09SimView/09_04_Documentation_of_model.md). *ModelDoc* er en sorteret dokumentation af modellen.
