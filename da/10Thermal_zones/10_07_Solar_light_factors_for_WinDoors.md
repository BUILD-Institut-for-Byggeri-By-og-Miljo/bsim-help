...
Beskrivelse af, hvorledes de to bidrag for hver af sollysfaktorerne kan beregnes eller bestemmes ud fra kurver findes i: [Algoritmer til beregning af solstråling og dagslys.](../20The_Mathematical_Basis/20_03_Algorithms_for_solar_radiation_and_daylight_calculations.md)
...
Figuren nedenfor viser eksempler på beregnede værdier af SF1 på arbejdsplanet i en linie midt i rummet for forskellige vinduesstørrelser og som funktion af afstanden fra vinduet (jf. ([Johnsen, Grau & Christensen, 1993](../20The_Mathematical_Basis/20_04_Literature_references.md)).
