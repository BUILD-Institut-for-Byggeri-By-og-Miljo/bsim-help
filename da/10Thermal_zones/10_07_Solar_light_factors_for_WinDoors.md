...
Beskrivelse af, hvorledes de to bidrag for hver af sollysfaktorerne kan beregnes eller bestemmes ud fra kurver findes i: [Algoritmer til beregning af solstråling og dagslys.](../20The_Mathematical_Basis/20_22_Algorithms_for_calculation_of_solar_radiation_and_daylight.md)
...
Ved definition af WinDoor i databasen indlæses værdier af varme- og lystransmission for den aktuelle rudetype. Normalt anvendes standardværdier for transmissionstallene, som ikke tager hensyn til snavs på ruden, ligesom der ikke korrigeres for lokalt forøget luftforurening, som reducerer solindfaldet. For solvarmeberegninger har sådanne forhold kun lille betydning, mens det i forbindelse med dagslys kan være vigtigt at tage hensyn hertil. I [algoritmer for beregning af solstråling og dagslys](../20The_Mathematical_Basis/20_22_Algorithms_for_calculation_of_solar_radiation_and_daylight.md), er angivet en tabel med vejledende værdier for de vigtigste korrektioner.
