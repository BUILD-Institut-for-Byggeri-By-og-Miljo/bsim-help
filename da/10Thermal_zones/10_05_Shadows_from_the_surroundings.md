...
Omgivelsernes skygger på bygningen defineres lige som modellen for en bygning. Der kan indsættes bygninger fra en tidligere model som skygge i den aktuelle model. Ved simulering med *tsbi5* vil kun den [aktuelle](../24Miscellaneous/24_22_Thermal_simulation.md) bygning blive simuleret.
...
<img src="./assets/INSERT.GIF" alt="Insert dialogen viser placeringen af det valgte punkt i planen samt bygningernes skalering i øst, nord og Z retningen og det indsatte projekts rotation."> 
...
<figure id="center_img">
<img src="./assets/INS-PROJ.GIF" alt="Dialog (Select a Project to Insert) for indsættelse af eksterne skygger fra et eksisterende projekt."> 
...
<figure id="center_img">
<img src="./assets/insert-simview.gif" alt="SimView med en ekstern skyggegiver indsat som en bygning fra et eksisterende projekt."> 
<figcaption>SimView med en ekstern skyggegiver indsat som en bygning fra et eksisterende projekt.</figcaption>
</figure>

Se også:

*   [Simulering med XSun](../14XSun_Analysis_of_incident_solar_radiation/14_01_Analysis_of_incident_solar_radiation_with_XSun.md)
