...
*   *<u>N</u>ew*: Starter [wizard'en](../09SimView/09_12_Model_wizard_creating_a_new_model.md) til oprettelse af en ny model. Der spørges, om den aktuelle model skal gemmes, inden der skiftes til oprettelse af den nye model.
...
*   *Recover*: Åbner en dialog, som giver mulighed for at åbne en [sikkerhedskopi](../06BSim_Program_structure/06_07_SimView_Printing_a_model.md) af modellen, hvis programmet af en eller anden grund er gået ned.
...
*   Export ...: (Når <span id="red_text"> ***SimView*** </span> er aktiv):
    ...
    *   *Save As Radiance*: Gemmer modellens geometri samt eventuelle informationer om [overfladeegenskaber](../07SimDB_Database/07_08_SimDB_BuildingMaterial_Finish.md) i en ekstern fil som kan læses ind i [Radiance](../18Radiance_Visualisation_og_the_building/18_01_Exporting_data_to_Radiance.md).

    *   *DirectX*: (fra BSim version 2002) Gemmer geometrien i en ekstern fil (*.x) der kan læses ind i et grafikprogram der understøtter [Direct-X](../24Miscellaneous/24_13_Visualising_with_DirectX.md).
...
*   *Weather Data*: Når <span id="red_text"> ***tsbi5*** </span> er aktiv optræder desuden en indgang til konvertering af klimadata for brug i simuleringerne med tsbi5:
    ...
    *   *Convert*: Åbner en dialog for [konvertering af klimadata](../13tsbi5_thermal_simulation/13_03_Converting_weather_data_for_tsbi5.md) på ASCII (tekst) format til det binære format som benyttes i tsbi5.
...
*   *<u>P</u>rint*: Udskriver dokumentationen for modellen svarende til [*ModelList*](../09SimView/09_04_Documentation_of_model.md).
