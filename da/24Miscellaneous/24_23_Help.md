...
*   *Help Topics*: Åbner den valgte [standardhjælpetekst](/24Miscellaneous/24_16_tsbi5_general_options.md) (dansk eller engelsk) med indholdsfortegnelsen i vinduet.
...
*   *BSim on the Web* giver adgang til en undermenu hvor:
    ...
    *   *Mail to BSim* ... åbner en almindelig e-mail dialog til *BSim* hvor det er muligt at stille [spørgsmål](../05Introduction/05_09_Questions_via_e-mail.md) om *BSim* og som sendes ud på en dansk eller engelsk fordelingsliste og distribueres automatisk til alle, som er tilmeldt listen. **NB**: Det er **kun** [medlemmer](../05Introduction/05_09_Questions_via_e-mail.md) der kan skrive til listen.
...
*   *About BSim*: Åbner en [dialog](../06BSim_Program_structure/06_02_About_BSim.md) med information om *BSim* (versionsnummer mv.), de tilknyttede moduler (DLL) samt et kort resume af systeminformationen for pc'en.
