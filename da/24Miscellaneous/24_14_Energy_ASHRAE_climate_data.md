...
*   Konverteringen sker på samme måde som for den [manuelle konvertering](/24Miscellaneous/24_13_Conversion_of_weather_data_to_tsbi5.md) af klima filer til BSim's format. I samme mappe som klimafilen er placeret, opretter BSim en *.wdf (Weather Definition File), med den information som er nødvendig for at konvertere fra *.epw til *.dry formatet.
