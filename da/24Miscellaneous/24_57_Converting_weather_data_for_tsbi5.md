...
*   [*Fixed columns from left to right*](/24Miscellaneous/24_61_Climate_data_fixed_format.html): I feltet angives placeringen af data i kolonner (index startende med 1 længst til venstre). Benyttes alene i forbindelse med formatet *Fixed*.
