...
Den termiske simulering af bygningens *termiske zoner* foregår i programmet *tsbi5*. Simuleringen i *tsbi5* gennemføres for den aktuelle bygning (*CurrentBuilding*). Hvis der er flere bygninger ([skygger fra omgivelser](../10Thermal_zones/10_05_Shadows_from_the_surroundings.md)) i modellen er den aktuelle bygning markeret med fed skrift i træ-visningen.

<figure id="center_img">
<img src="./assets/current-tree.gif" alt="Den aktuelle bygning markeres med fed skrift i træ-visningen.">
