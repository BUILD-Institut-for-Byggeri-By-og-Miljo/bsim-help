...
*Options*...: Åbner [dialogen](../06BSim_Program_structure/06_07_Options.md) for ændring af programmets indstillinger. Hvis tsbi5 er aktiv åbnes en [dialog for ændring af standardparametrene for tsbi5](/24Miscellaneous/24_16_tsbi5_general_options.md).

*   *Default*...: Åbner en [dialog](../06BSim_Program_structure/06_14_Default_constructions.md) for tilknytning af standardkonstruktioner samt databasen hvorfra konstruktionerne vælges, ved at holde venstre knap på musen nede, medens konstruktionen trækkes til *Defaults* dialogen.
...
*   *<u>I</u>nsert*: Giver mulighed for at indsætte følgende objekter i modellen:
    ...
    *   en eller flere bygninger fra et andet projekt. *Insert* | *Building* funktionen benyttes i forbindelse med definition af [skygger](../09SimView/09_02_Shading_from_surroundings.md) fra omgivelserne eller ved import af flere etager fra CAD grundlag i [SimDXF](../08SimDXF_CAD_drawings_as_basis_for_geometry/08_01_CAD_drawings_as_basis_for_geometry.md).
...
*   *Add*: Giver mulighed for at tilføje objekter til modelgeometrien i SimView:
    ...
    *   et rum ([*Room*](../09SimView/09_04_Create_a_room.md)) på den valgte flade,

    *   en flade (*Face*) mellem valgte vetrexes (hjørnepunkter) i fladen,

    *   en kant (*Edge*) mellem punkter i den valgte flade,

    *   en eller flere [WinDoor](../08SimDXF_CAD_drawings_as_basis_for_geometry/08_06_Add_opening_or_WinDoor.md) i den valgte flade,

    *   en eller flere åbninger (*Opening*) i den valgte flade,

    *   et eller flere moduler ([*PvArray*](../16SimPV/16_01_PV_array.md)) med solceller i den valgte flade (BSim udvidelsesmodul),
...
*   *Move*: Åbner en dialog for [flytning af en flade](../09SimView/09_08_Move_face.md) parallelt med fladens normal.
...
*   *Clean Model*: Rydder op i modellen og fjerner overflødig information:
    ...
    *   *Geomerty* fjerner hjørnepunkter som ligger mindre end "*snap*" (se [Options](../06BSim_Program_structure/06_07_Options.md)) afstanden fra hinanden.
