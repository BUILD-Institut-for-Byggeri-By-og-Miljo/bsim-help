...
*Sf4 shading* angiver sollyssfaktoren for den aktuelle WinDoor, når solafskærmningen er trukket for. Sollyssfaktoren er kun relevant i forbindelse med dagslyafhængig lysregulering, og er knyttet til **ét** bestemt punkt i rummet. Sollyssfaktoren er defineret som belysningsstyrken i dette punkt divideret med den udvendige belysningsstyrke på WinDoor-planet. Når solafskærmningen er trukket (helt eller delvist) for, erstatter Sf4 de øvrige definerede [sollysfaktorer](../10Thermal_zones/10_07_Solar_light_factors_for_WinDoors.md) Sf1, Sf2 og Sf3 for den 'del' af WinDoor, hvor afskærmningen er trukket for. Er afskærmningen fx 'trukket 60 % for', beregnes dagslysets ved vægtning (0,6/0,4) af de to værdier, der beregnes med og uden afskærmning.

Standardværdien for Sf4 er 0, ligesom de [øvrige sollysfaktorer](../10Thermal_zones/10_07_Solar_light_factors_for_WinDoors.md). Dagslysfaktorerne er nærmere beskrevet under tidsplanen for [belysning](../11Systems/11_03_Systems_Lighting.md).
