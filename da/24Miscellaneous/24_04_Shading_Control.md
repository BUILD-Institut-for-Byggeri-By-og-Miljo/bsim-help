...
*Sf4 shading* angiver sollyssfaktoren for den aktuelle WinDoor, når solafskærmningen er trukket for. Sollyssfaktoren er kun relevant i forbindelse med dagslyafhængig lysregulering, og er knyttet til **ét** bestemt punkt i rummet. Sollyssfaktoren er defineret som belysningsstyrken i dette punkt divideret med den udvendige belysningsstyrke på WinDoor-planet. Når solafskærmningen er trukket (helt eller delvist) for, erstatter Sf4 de øvrige definerede [sollysfaktorer](../15SimLight_Daylight_calculations/15_08_Daylight_factors_for_windows.md) Sf1, Sf2 og Sf3 for den 'del' af WinDoor, hvor afskærmningen er trukket for. Er afskærmningen fx 'trukket 60 % for', beregnes dagslysets ved vægtning (0,6/0,4) af de to værdier, der beregnes med og uden afskærmning.

Standardværdien for Sf4 er 0, ligesom de [øvrige sollysfaktorer](../15SimLight_Daylight_calculations/15_08_Daylight_factors_for_windows.md). Dagslysfaktorerne er nærmere beskrevet under tidsplanen for [belysning](../11Systems/11_02_Lighting_system.md).
