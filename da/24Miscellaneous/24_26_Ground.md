...
I henhold til [DS418, tillæg 4](../20The_Mathematical_Basis/20_28_Literature.md), kan den dimensionerende jordtemperatur under opvarmede bygninger og i de dybereliggende jordlag omkring opvarmede bygninger fastsættes til 10 °C.
...
*   **R<sub>si</sub>** er overgangsisolansen ved den indvendige overflade i enheden m²K/W. Denne størrelse fremgår ikke af oplysningerne om konstruktionerne i visningen med [SimDB](../07SimDB_Database/07_02_SimDB_BuildingElement.md).

*   **R<sub>m</sub>** er isolansen for materialelag i selve gulv- eller vægkonstruktionen i enheden m²K/W. Vises som en information i [SimDB](../07SimDB_Database/07_02_SimDB_BuildingElement.md).
