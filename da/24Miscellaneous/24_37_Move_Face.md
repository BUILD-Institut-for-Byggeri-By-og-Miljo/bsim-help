...
*   *Options* giver mulighed for at vælge hvordan flytningen skal influere på de tilstødende rum:
    ...
    *   Ved at sætte hak ud for "*Move all adjacent Faces that are parallel*" vil modellens øvrige flader som har en normalvektor parallel med fladens normalvektor **og** ligger i samme plan som den aktuelle flade skal flyttes sammen med fladen.

    *   Et hak ud for "*Keep adjacent room geometry*" sikrer at de tilstødende rum bevarer deres geometri.
