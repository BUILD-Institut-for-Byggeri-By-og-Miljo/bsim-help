...
Modelens systemlinjer tegnes i [SimView](../09SimView/09_01_SimView.md) eller importers fra en CAD tegning ved hjælp af [SimDXF](../08SimDXF_CAD_drawings_as_basis_for_geometry/08_01_CAD_drawings_as_a_basis_for_geometry.md) programmet.
...
Der kan foretages en simpel redigering direkte i træ-oversigten. Ved at trække fx et system fra en termisk zone til en anden flyttes systemet. Rum [tilføjes til termiske zoner](../10Thermal_zones/10_02_SimView_Adding_spaces_to_thermal_zones.md) ved at trække dem ind i zonen.

I alle programmerne i BSimpakken er det muligt at kalde en menu frem ved at klikke på musens højre knap. Menuen er forskellig i de forskellige programmer ([*SimView*](../09SimView/09_01_SimView.md), [*Xsun*](../14XSun_Analysis_of_incident_solar_radiation/14_01_Analysis_of_incident_solar_radiation_with_XSun.md), [*tsbi5*](../13tsbi5_thermal_simulation/13_01_tsbi5.md) og [*SimLight*](../15SimLight_Daylight_calculations/15_01_Daylight_calculations_with_SimLight.md)) og indeholder de mest benyttede funktioner på det aktuelle sted.

Det er muligt at vælge (udpege) flader (konstruktioner) direkte i den geometriske visning ved at flytte musemarkøren til det ønskede objekt og trykke på *Ctrl + "venstre klik"* i 3D-visningen. Derved markeres objektet med rød farve i den geometriske visning og den aktuelle konstruktion markeres i træ-oversigten. Det er også muligt at vælge et objekt direkte ved klik i træ-oversigten (se: [Tilføje et rum](../09SimView/09_15_SimView_Creating_a_space.md)). Det er ofte lettere at udpege den ønskede konstruktion i træ-oversigten, end i 3D geometrien.
...
*   [Programmenuerne](../06BSim_Program_structure/06_04_Program_menus_in_BSim.md)