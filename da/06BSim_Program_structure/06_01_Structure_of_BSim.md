...
I alle programmerne i BSimpakken er det muligt at kalde en menu frem ved at klikke på musens højre knap. Menuen er forskellig i de forskellige programmer ([*SimView*](../09SimView/09_01_SimView.md), [*Xsun*](../14XSun_Analysis_of_incident_solar_radiation/14_01_Analysis_of_incident_solar_radiation_with_XSun.md), *tsbi5* og [*SimLight*](../15SimLight_Daylight_calculations/15_01_Daylight_calculations_with_SimLight.md)) og indeholder de mest benyttede funktioner på det aktuelle sted.
