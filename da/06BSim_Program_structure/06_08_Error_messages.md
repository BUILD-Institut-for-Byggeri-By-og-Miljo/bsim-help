...
| No construction type | Fladen har ikke tilknyttet en konstruktion (materialelag).<br>Der kan tilknyttes [standardkonstruktioner](../24Miscellaneous/24_28_Insert_Default_Options.md) til en flade eller [frit valgte konstruktioner](../09SimView/09_09_SimView_Non_default_constructions.md) fra databasen. |
| No windoor type | Der er ikke tilknyttet materialeegenskaber til WinDoor'en.<br>Der kan tilknyttes materialeegenskaber som [standardkonstruktioner](../24Miscellaneous/24_28_Insert_Default_Options.md) eller som [frit valg fra databasen](../09SimView/09_09_SimView_Non_default_constructions.md). |
...
| No component | Systemets fysiske egenskaber er ikke defineret.<br>Højre-klik på systemet og definer dets fysiske egenskaber på første faneblad. |
| No schedule | Systemet som er oprettet har ikke fået tilknyttet en [tidsplan](../11Systems/11_02_Systems_schedule.md).<br>Højre-klik på systemet i træet, skift til *Schedule*-fanebladet og definer en tidsplan for reguleringen af systemet. Hvis systemet ikke skal bruges i denne simulering kan det i stedet slås fra ved at højre-klikke på den termiske zone og markere systemet med et gråt "hak". |
...
| No time | Systemet som er oprettet har ikke en tilknyttet [tidsangivelse](../11Systems/11_17_Systems_Time.md).<br>Højre-klik på systemet i træet, skift til *Time*-fanebladet og definer en tidsangivelse for systemet. Hvis systemet ikke skal bruges i denne simulering kan det i stedet slås fra ved at højre-klikke på den termiske zone og markere systemet med et gråt "hak". |
| Unknown (Mixing) | Kilden for luft ind i den termiske zone ved [*Mixing*](../11Systems/11_10_systems_mixing.md) er udefineret. |
| General Lux | Det generelle belysningsniveau (Gen. Lighting Level) i lux er udefineret (<= 0). |
| Unknown (Ventilation - Natkøling) | Sensorzonen for regulering af natkøling er udefineret.<br>Højre-klik på systemet i træet, skift til [*NightCoolCtrl*-fanebladet](../11Systems/11_24_Ventilation_Night_Cooling_Control.md) og definer en sensorzone for ventilationssystemet. |
