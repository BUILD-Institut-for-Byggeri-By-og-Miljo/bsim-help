...
Konstruer et knudepunkt (*Node*) i begge vinduets (eller dørens) sider. Tegn et rektangel, der indeholder disse knudepunkter. Tast Ctrl + w for et vindue eller Ctrl + d for en dør. Indtast evt. navn og øvrige data.

<figure id="center_img">
<img src="./assets/DXF09.GIF " alt="Markering for indsættelse af vindue.">
<figcaption>Markering for indsættelse af vindue.</figcaption>
</figure>

<figure id="center_img">
<img src="./assets/DXF10.GIF" alt="Den oprettede model, inden den gemmes i BSim-format.">
<figcaption>Den oprettede model, inden den gemmes i BSim-format.</figcaption>
</figure>
 
