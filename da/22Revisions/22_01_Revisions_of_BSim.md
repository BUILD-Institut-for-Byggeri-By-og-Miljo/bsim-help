...
*   SimView, DisDb5, Modellen: Fejl ved udefineret materiale i fugtegenskaber i databasen (et materiale findes i thermal-tabellen men ikke i moisture-tabellen). Se [begrænsninger](../05Introduction/05_05_Limitations.md).
