...
[EKS1](../21Getting_started_with_BSim/21_03_Example_1.md)   Start af BSim, indlæsning af bygninger med rum og flader, konstruktioner og vinduer, kopiering af data samt gem modellen.

[EKS2](../21Getting_started_with_BSim/21_04_Example_2.md)   Åbning af eksisterende model, indlæsning af systemer og tidsplaner samt gennemførsel af de første simuleringer og behandling af resultaterne herfra.

[EKS3](../21Getting_started_with_BSim/21_05_Example_3.md)   Detaljering af bygningsmodellen, tilføjelser af skyggegivere, ændring af rudetype samt tilføjelse af solafskærmning og ventilationsanlæg. Ny simulering, resultatanalyse og sammenligning med tidligere resultater, oprettelse af parameterlister, udskrift i tabeller og grafik.

Ved gennemgangen af eksemplerne forudsættes det, at brugeren har læst afsnittene om programmets [centrale brugergrænsflade (SimView)](../09SimView/09_01_SimView.md) og er fortrolig med [håndtering af mus](../06BSim_Program_structure/06_03_Mouse_operations_in_SimView.md) og tastatur i BSim samt har kendskab til brug af programmer under MS-Windows.
...
Som udeklima benyttes data fra det [danske design referenceår](../20The_Mathematical_Basis/20_28_Literature.md), DRY, hvorfra de nødvendige vejrparametre findes på BSim format som filen CPH.DRY. For alle udvendige vægge samt taget vender den ene side mod udeluften. Gulvet er i termisk kontakt med en fiktiv zone (jorden) med en fast temperatur på 10 °C. Refleksionen af solstråling fra omgivelserne er 20 %. De udvendige overflader har en absorptionskoefficient for solstråling på 0,7.

 

**Overgangsisolanser**

Overgangsisolansen sættes på flader defineres jf. [DS 418](../20The_Mathematical_Basis/20_28_Literature.md) som angivet i standardværdier.
...
Ud fra ovenstående beskrivelse skal den bygningsmæssige del af modellen indlæses i BSim. Øvrige data for systemer, solafskærmninger, skygger mv. beskrives i [eksempel 2](../21Getting_started_with_BSim/21_04_Example_2.md).
