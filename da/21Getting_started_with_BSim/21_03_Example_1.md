...
Beskrivelsen af datainlæsning for systemer beskrives i [Eksempel 2](../21Getting_started_with_BSim/21_04_Example_2.md), hvor der kan fortsættes direkte. Såfremt datainlæsningen ønskes afsluttet her, klikkes med musen i menuen *File* på feltet *Exit* eller der klikke med musen på **x**'et i øverste højre hjørne af programvinduet.

 

Se også:

*   [Eksempel 2 - Bygningens systemer](../21Getting_started_with_BSim/21_04_Example_2.md)
