...
*   [*Sidefin* og *Overhang*](../24Miscellaneous/24_54_WinDoor_overhangs_and_side-fins.md): Den lokale geometri omkring objektet kan beskrives ved klik på knapperne [*Left*, *Right* og *Top*](../24Miscellaneous/24_54_WinDoor_overhangs_and_side-fins.md), som kalder dialoger frem til definition af geometrien for sidefinner og udhæng.   
<span id="red_text">**NB:** Overhang og Sidefin fungerer **nu** også sammen med [XSun solfordeling](../13tsbi5_thermal_simulation/13_02_tsbi5_options.md) men vises ikke i [XSun](../14XSun_Analysis_of_incident_solar_radiation/14_01_Analysis_of_incident_solar_radiation_with_XSun.md). Hvis et udhæng over eller langs et vindue skal simuleres med XSun solfordeling bør disse opbygges geometrisk i modellen.   
