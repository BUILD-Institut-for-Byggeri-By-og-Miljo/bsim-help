...
Forklaring på de enkelte parametre i varmebalancen kan ses på [*Parametre i varmebalancen*](../13tsbi5_thermal_simulation/13_11_Parameters_in_the_result_log.md).
...
*   [*Yscale* ](../24Miscellaneous/24_50_Graph_Scale.md)åbner en dialog for fastlåsning af y-skalaen fra periode til periode samt ændring af den grafiske visning.

*   Afslut den grafiske visning af resultaterne.

Ved højre-klik i den grafiske visning af resultaterne fremkommer en dialog, som giver mulighed for at [ændre den grafiske visning af resultaterne](../13tsbi5_thermal_simulation/13_12_Modifying_the_graphical_presentation_of_results.md).
