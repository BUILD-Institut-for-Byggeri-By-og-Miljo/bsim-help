...
<img src="./assets/WIZARD2D.GIF" alt="Dialog (Chart Wizard | Gallery) for valg mellem forskellige 2D-visninger af resultater.">
<figcaption>Dialog (Chart Wizard | Gallery) for valg mellem forskellige 2D-visninger af resultater.</figcaption>
</figure>

<figure id="center_img">
<img src="./assets/WIZARD3D.GIF" alt="Dialog for valg mellem forskellige 3D-visninger af resultater.">
...
<figure id="center_img">
<img src="./assets/wizard3d1.gif" alt="Dialog (Chart Wizard | Style) for detailopbygning af den valgte visning.">
...
<figure id="center_img">
<img src="./assets/wizard3d2.gif" alt="Dialog (Chart Wizard | Layout) med eksempel på den endelige grafiske repræsentation af data inkl. mulighed for tildeling af ny titel (Chart Title), fodnote (Chart Footnote) og placering af signaturforklaring (Chart Legend).">
...
Hvis man skulle fortryde ændringerne af grafens udseende, er det muligt at vende tilbage til udgangspunktet ved tryk på [*Reset Chart To Defaults*](../13tsbi5_thermal_simulation/13_13_Chart_Designer.md) på første faneblad i *Chart Designer*.
