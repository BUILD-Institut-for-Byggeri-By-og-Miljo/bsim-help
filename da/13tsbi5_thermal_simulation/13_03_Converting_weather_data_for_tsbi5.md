...
<span id="gray_background">*NB: Hvis data indeholder ikke-numeriske informationer på samme linje som timedata, er dette format det eneste som kan benyttes*.</span>
...
*   [*Fixed columns from left to right*](../13tsbi5_thermal_simulation/13_03_Converting_weather_data_for_tsbi5.md): I feltet angives placeringen af data i kolonner (index startende med 1 længst til venstre). Benyttes alene i forbindelse med formatet *Fixed*.
...
*   Lufttrykket i pascal (Pa) er nødvendig for at kunne simulere naturlig ventilation mellem flere zoner og omgivelserne. *Hvis lufttrykket angives til at være konstant 0 eller udelades benyttes en fast værdi som kan beregnes ud fra højden over havet. Der kan stadig gennemføres en simulering af naturlig ventilation med multi-zone modellen, men med reduceret nøjagtighed.*
