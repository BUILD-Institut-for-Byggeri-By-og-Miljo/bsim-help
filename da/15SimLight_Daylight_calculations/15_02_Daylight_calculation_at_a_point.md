...
Det er muligt at vælge mellem forskellige referencepunkter som er defineret inden for de aktuelle rum. Der kan oprettes flere referencepunkter ved at højre-klikke på et rum og vælge indgangen [*Ref. points*](../10Thermal_zones/10_03_Reference_point.md).
...
*Advanced FormFactor* giver mulighed for at vælge en mere [avanceret](../20The_Mathematical_Basis/20_28_Literature.md) algoritme for beregning af vinkelstrålingstallet. Dette kan særlig være nyttigt hvis resultaterne med den [almindelige](../20The_Mathematical_Basis/20_28_Literature.md) algoritme giver utroværdige resultater.
...
Ved klik i [*Calculation for multiple points*](../15SimLight_Daylight_calculations/15_03_Daylight_calculation_on_a_plane.md) åbnes en dialog til definition af en plan hvori der skal foretages en beregning af dagslysforholding.
