...
Zonens fugttilskud stammer fra personer, andre fugtbelastninger i zonen samt de fugttilskud, der kan være i forbindelse med de tre former for lufttilførsel: [infiltration](../11Systems/11_04_Infiltration_system.md), [udluftning](../11Systems/11_06_Venting_system.md) samt (mekanisk) [ventilation](../11Systems/11_05_Ventilation_system.md). Hertil kommer det fugttilskud, der kan være ved tilførsel af luft fra nabozoner, [mixing](../11Systems/11_02_Systems_mixing_system.md). Der regnes derimod ikke med affugtning af rumluften ved kondensation i zonen, hverken på kolde overflader af vinduer eller konstruktioner eller på køleradiatorens overflade.
