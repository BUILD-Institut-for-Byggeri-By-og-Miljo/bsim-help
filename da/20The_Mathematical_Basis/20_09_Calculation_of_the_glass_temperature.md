...
Hvis det antages, at et glas altid har to lag, og at lagenes absorbtans er SA<sub>i</sub> og reflektans er SR<sub>i</sub> (*gælder <u>ikke</u> for glas med hård coating!!*). Disse antagelser er ok for vinduer med 1 og 2 glaslag, men ikke for flere glaslag.
...
Herefter kan temperaturen for overfladerne beregnes som en varmebalance til den nærmeste lufttemperatur med den absorberede stråling som et nyt led i den sædvanlige ligning for beregning af varmetabet alene på grund af den mørke U-værdi:
...
Til brug for den langbølgede strålingsudveksling med glassets overflader kan den gennemsnitlige emissionskoefficient (ε = 0,94) for glas benyttes på alle glasoverflader.
