...
Værdien bestemmes i henhold til [By og Byg (SBi), Anvisning 202](../20The_Mathematical_Basis/20_13_Extract_from_by_og_byg_direction_202.md), side 70-71:
...
Læs yderligere i [By og Byg Anvisning 202](../20The_Mathematical_Basis/20_13_Extract_from_by_og_byg_direction_202.md).

## **Indblæsningstemperaturkonstanten Ka**

Værdien bestemmes i henhold til [Danvak grundbogen, kapitel 7](../20The_Mathematical_Basis/20_28_Literature.md) hvor yderligere forklaring og koefficienter kan findes i kapitlet *Luftfordeling i rum* afsnittet *Luftstråler.*
...
Læs yderligere i [Danvak grundbogen, kapitel 7](../20The_Mathematical_Basis/20_28_Literature.md).
