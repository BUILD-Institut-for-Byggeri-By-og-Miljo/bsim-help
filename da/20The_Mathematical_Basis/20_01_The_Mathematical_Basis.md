...
*   [Programmets bygningsopfattelse, knudepunktsinddeling](../20The_Mathematical_Basis/20_02_Building_description_and_definition_of_nodes_in_constructions.md)

*   [Varmebalancen for luften i en termisk zone](../20The_Mathematical_Basis/20_25_Heat_balance_for_the_zone_air.md)

*   [Varmetransport i konstruktionerne](../20The_Mathematical_Basis/20_26_Heat_transmission_in_constructions.md)

*   [Fugtbalancen for en termisk zone](../20The_Mathematical_Basis/20_04_Moisture_balance_for_a_zone.md)

    *   [Detaljeret fugtbalance, BSim](../20The_Mathematical_Basis/20_05_Detailed_Moisture_balance.md)

    *   [Automatisk netinddeling ved fugtberegninger, BSim](../20The_Mathematical_Basis/20_06_Automatic_net_generation.md)

    *   [Fugttransport med hysterese, BSim](../20The_Mathematical_Basis/20_07_Moisture_transport_with_hysteresis.md)

    *   [Effektiv indtrængningsdybde for fugt, BSim](../20The_Mathematical_Basis/20_08_Effective_Moisture_Penetration_Depth,_and_Automatic_Grid_Generation_in_BSim2000_for_Moisture_Calculations.md)

*   [Naturlig konvektion ved overflader](../20The_Mathematical_Basis/20_11_Natural_convection_at_surfaces.md)
...
*   [Vandbåren gulvvarme/køling (engelsk)](../20The_Mathematical_Basis/20_27_Floor_heating_mathematical_basis.md)
